...
public class Settings: MonoBehaviour
{
    ...
    [SerializeField] private bool _autoEmulationSteps;

    private bool[] _flags, _tmp;
    private Toggle[] _toggles = new Toggle[7];
    ...
    public void SaveSettings()
    {
        ...
        Debug.Log($"{_tmp[0]} {_tmp[1]} {_tmp[2]} {_tmp[3]} {_tmp[4]} {_tmp[5]} {_tmp[6]} ");
    ...
    public void LoadSettings()
    {
        ...
        Debug.Log(serializedSettings);
        //Debug.Log(RegExpressions.boolValFromJSON.Matches(serializedSettings).ToString());
