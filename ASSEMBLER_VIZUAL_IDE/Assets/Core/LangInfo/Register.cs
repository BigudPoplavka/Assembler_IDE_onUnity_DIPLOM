...
[CreateAssetMenu(fileName = "New Register", menuName = "Register", order = 51)]

public class Register: ScriptableObject
{
    [SerializeField] private Regname _regName;
    [SerializeField] private int _size;
    [SerializeField] private Sprite _descrImage;
    ...
    public Sprite DescrImage { get => _descrImage; set => _descrImage = value; }
