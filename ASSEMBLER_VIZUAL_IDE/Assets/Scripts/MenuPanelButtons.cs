...
[System.Serializable]
public class OnEmulatorStarted : UnityEvent<List<Instruction>> { }
...
public class MenuPanelButtons : MonoBehaviour
{
    ...
    [SerializeField] private OnEmulatorStarted _onEmulatorStarted = new OnEmulatorStarted();
    ...
    [SerializeField] private UnityEngine.UI.Button _runButton;
    ...
    public void ResetRunButtonInteractableState()
    {
        _runButton.interactable = GlobalVariables._isEmulationAvailable;
    }
    ...
    {
        _onEmulatorStarted?.Invoke(Core.buider.Instructions);
    }
